...
//gameover
			...
			{tu=0;
				if(lift==0)
				{
					if(sel==0)
					{
						if(!side1)
						{
							if(left($("#bottle_1"))>300)$("#bottle_1").animate({left:-50},2000,"linear",function(){s5();});
							else  $("#bottle_1").animate({left:-50},1000,"linear",function(){s5();});}
							else 
							{
								if(left($("#bottle_1"))<300)$("#bottle_1").animate({left:600},2000,"linear",function(){s5();});
								else  $("#bottle_1").animate({left:600},1000,"linear",function(){s5();});
							}
						}
						 if(sel==1)
						 {
						 	if(!side2)
						 	{
						 		if(left($("#bottle_2"))>300)$("#bottle_2").animate({left:-50},2000,"linear",function(){s5();});
						 		else $("#bottle_2").animate({left:-50},1000,"linear",function(){s5();})
						 	}
						 	else
						 	{
						 		if(left($("#bottle_2"))<300)$("#bottle_2").animate({left:600},2000,"linear",function(){s5();});
						 		else $("#bottle_2").animate({left:600},1000,"linear",function(){s5();});
						 	}
						 }
						 if(sel==2)
						 {
						 	if(!side3)
						 	{
						 		if(left($("#bottle_3"))>300)$("#bottle_3").animate({left:-50},2000,"linear",function(){s5();});
						 		else $("#bottle_3").animate({left:-50},1000,"linear",function(){s5();});
						 	}
						 	else
						 	{  
						 		if(left($("#bottle_3"))<300)$("#bottle_3").animate({left:600},2000,"linear",function(){s5();});
						 		else $("#bottle_3").animate({left:600},1000,"linear",function(){s5();});
						 	}
						 }
					}
					...
					if((tu4==0||completed==0)&&((left($("#basket"))>-150)&&(left($("#basket"))<550)))
					{
						if(!side8)
						{
							if(left($("#basket"))>300)$("#basket").animate({left:-150},2000,"linear",function(){$("#basket").hide();s9();});
							else $("#basket").animate({left:-150},1000,"linear",function(){$("#basket").hide();s9();});
						}
						else
						{
							if(left($("#basket"))<300)$("#basket").animate({left:550},2000,"linear",function(){$("#basket").hide();s9();});
							else $("#basket").animate({left:550},1000,"linear",function(){$("#basket").hide();s9();});
						}
					}
				}
			}
	    ...
	    if(key==39)
			...
			*/
			...
			switch(drop)
			{
			case 1:tu3=1;$("#bottle_1").stop("true");$("#bottle_1").animate({top:350},600,"linear",function(){s10();
				$("#bottle_1").clearQueue();completed=1;$("#bottle_1").hide();lift=0;tu3=0;});break;
			case 2:tu3=1;$("#bottle_2").stop("true");$("#bottle_2").animate({top:350},600,"linear",function(){s10();
				$("#bottle_2").clearQueue();completed=1;$("#bottle_2").hide();lift=0;tu3=0;});break;
		    case 3:tu3=1;$("#bottle_3").stop("true");$("#bottle_3").animate({top:350},600,"linear",function(){s10();
