...
var chipSel=1;
var balanceCash=-1;
$.ajax({url:"http://www.pragyan.org/~boopathi/festember11/apps/roulette/getCashRelay.php",success:function(html){ balanceCash=html; console.log(html);}, dataType:"html" });
var bettingCash=0;
