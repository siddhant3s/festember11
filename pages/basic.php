...
<table id="r_table">
<tr><td>Login Name / Mail id</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input disabled="true" id="sname" autocomplete=off name="sname" type="text" size="20" value="<?php echo $_SESSION['OPENID_WELCOME_NAME'];?>"></td></tr>
