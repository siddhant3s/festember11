<div class="content-head">SPONSORS / PARTNERS</div>
<script type="text/javascript">
$("document").ready(function(){
$("a.merch img").css("width","120px");
$("a.media img").css({width:'120px',padding:'5px'});
});
</script>
<div class="content-body">
	<div style="width:400px; text-align:center; margin:auto;">
		<h3 style="line-height:25px; font-size:15px; font-weight: bold; text-shadow: 0px 0px 5px #aaa">Merchandise Partner</h3>
		<a class="merch" href="http://www.esparsha.com" target="_blank"><img src="./images/s1.jpg"></a><br/>
		...
		<br /><br />
		<h3 style="line-height:25px; font-size:15px; font-weight: bold; text-shadow: 0px 0px 5px #aaa">Apekshaa Partner</h3>
		<a class="media" href="http://www.dhl.com/en.html" target="_blank"><img src="./images/s18.jpg"></a>
		<br /><br />
		<h3 style="line-height:25px; font-size:15px; font-weight: bold; text-shadow: 0px 0px 5px #aaa">Style Partner</h3>
		<a class="media" href="http://www.dhl.com/en.html" target="_blank"><img src="./images/s17.jpg"></a>
		<br /><br />
		...
		<a class="media" href="http://www.studyvillage.com" target="_blank"><img src="./images/media2.jpg" /></a>
		<a class="media" href="http://www.indiastudychannel.com" target="_blank"><img src="./images/media3.jpg" /></a>
...
<!--
<div class="content-head">MEDIA PARTNERS</div>
<div class="content-body">
	<div class="partners" style="width: 400px;margin:auto;text-align:center">
